  ...
  module Tags
    class LatexBlock < Liquid::Block
      ...
      @@globals = {
        ...
        "density" => "300",
        "usepackages" => "",
        "latex_cmd" => "latex -interaction=nonstopmode $texfile >> $logfile 2>&1",
        "dvips_cmd" => "dvips -E $dvifile -o $epsfile >> $logfile 2>&1",
        "convert_cmd" => "convert -strip -define png:exclude-chunks=date -trim -density $density $epsfile $pngfile >> $logfile 2>&1",
